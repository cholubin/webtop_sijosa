...
class Admin::EbookcategoriesController < ApplicationController
  ...
  def index
    ...
    @categories = Category.all(:gubun => "ebook", :order => [ :priority.asc ])

     render 'ebookcategory', :layout => false
  end
  ...
  def create
    if params[:ebookcategories][:name] != "" and params[:ebookcategories][:sub_name] == ""
      @category = Category.new
      @category.name = params[:ebookcategories][:name]
      @category.gubun = "ebook"
      @category.priority = params[:ebookcategories][:priority].to_i
    ...
    elsif params[:ebookcategories][:name] == "" and params[:ebookcategories][:sub_name] != ""
      @category = Category.get(params[:ebookcategories][:main_category].to_i)
      @sub_category = @category.subcategories.new
      @sub_category.name = params[:ebookcategories][:sub_name]
      @sub_category.priority = params[:ebookcategories][:sub_priority].to_i
      ...
      if @subcategories.destroy
        ...
        if @category.destroy
          ...
          @sharedimages.each do |shared|
            if Category.first(:gubun => "ebook") != nil
              shared.category = Category.first(:gubun => "ebook").id
